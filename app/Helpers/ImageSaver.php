...
class ImageSaver
{
     ...
     */
    public function remove($item, string $dir): void
    {
        $old = $item->image;
        if ($old) {
     ...
     */
    private function resize(string $src, string $dst, int $width, int $height, string $ext): void
    {
